...
| BK06-002 | DBから初期表示 | セッションなし、書籍あり | bookId=1 | DB値から生成したフォーム表示 | `bookEditForm.title` 等が一致 |
...
| BK07-009 | 更新成功 | update が1を返す | - | 完了画面へリダイレクト | redirect=`/book/edit/complete?bookId=1`, セッション削除 |
